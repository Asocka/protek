...
ririn = LINE('ExlcWn8o9dclNeVIC1O6.NdrgfZO0Pzz35kyIid5DPG.6iOaS7Eb6RTipxixcDhPzhdQtgwf831Ufy1QT1/56jM=')
ririn.log("Auth Token : " + str(ririn.authToken))
channelToken = ririn.getChannelResult()
ririn.log("Channel Token : " + str(channelToken))

dna1 = LINE('Ex6lWg7KRSTEss6EbDH2.CqA0Tb76CIullIy0JTMiWG.ntgSp1BWY4mD7+oIsWAdgtJO0ETIAMGgvSbwd2sBLAs=')
dna1.log("Auth Token : " + str(dna1.authToken))
channelToken = dna1.getChannelResult()
dna1.log("Channel Token : " + str(channelToken))

dna2 = LINE('ExP4XbOqH49croULsQw9.bW8OePfd1ZZzEQ+yV9Nzkq.eMFIEehxJbigeM+FKsfVjMrlcSrH/Et6/M+sGt8t25s=')
dna2.log("Auth Token : " + str(dna2.authToken))
channelToken = dna2.getChannelResult()
dna2.log("Channel Token : " + str(channelToken))

dna3 = LINE('Ext1uwxI3T3ACBbwMr3f.7cNpbuPkRvQRw9wFFHG4VW.ayJ4R7B1BX0vq+VochRSupNMn6OgYgoTo0KappEHQ+U=')#kicker
dna3.log("Auth Token : " + str(dna3.authToken))
channelToken = dna3.getChannelResult()
dna3.log("Channel Token : " + str(channelToken))

dna4 = LINE('ExR55KijzWlMl01aFW44.LqnCtNWt/LpdnighLTCsXa.Ysxjz+GMCe/W6QuJ4nb5tfshtkTDkhsNv5MSjCx/d0E=')#kicker
dna4.log("Auth Token : " + str(dna4.authToken))
channelToken = dna4.getChannelResult()
dna4.log("Channel Token : " + str(channelToken))

dna5 = LINE('Ex6PAJWwWfltXj7AFCd5.bpYj/o2nMFT8mvFgM+K69q.rAPFS6Qi+gzsdLsCN8bVVI+hoUBMrUf8EWZee8WmIlg=')#kicker
...
Bots=[mid,Amid,Bmid,"uae65bf02566258685a194fc0bbb9b56d"]
admin=["uae65bf02566258685a194fc0bbb9b56d"]
Owner=["uae65bf02566258685a194fc0bbb9b56d"]
