...
riant = LINE('Eyb5Us5gO3DzgaVv8cY6.NsZPjPunmTH+PKzxl7LSbG.cRbmScsYrzBL8XoJyS9vcaDAsqwKG0fzsvS0438aJgE=')#masukan akun utama mu bro
riant.log("Auth Token : " + str(riant.authToken))
channelToken = riant.getChannelResult()
riant.log("Channel Token : " + str(channelToken))


ririn = LINE('Ey0SU7mv6bttliEROJce.hp5B9tFZE3J7QcaZR1k87G.OmqcIo4ZSwj1L0QPY8YQ7r3OevWsWcrAFRD1zuAzQXs=')
ririn.log("Auth Token : " + str(ririn.authToken))
channelToken = ririn.getChannelResult()
ririn.log("Channel Token : " + str(channelToken))

dna1 = LINE('EyCleO8bW6NOjmMogap4.2/tMJN1pyyItlLw7+xPZXa.1g2SP8ywi09njvjf0QCN7Qz1ptcdBrY4Pex9IgvBBmE=')
dna1.log("Auth Token : " + str(dna1.authToken))
channelToken = dna1.getChannelResult()
dna1.log("Channel Token : " + str(channelToken))

dna2 = LINE('Ey3VuVp7O3GCB5ASmQg2./zcYHLlBA7s2VxAlWFJquG.Wrg9+y0YpKUUaViS45+vp6HmqmoxZ/V4T89qsUlh4Bg=')
dna2.log("Auth Token : " + str(dna2.authToken))
channelToken = dna2.getChannelResult()
dna2.log("Channel Token : " + str(channelToken))

dna3 = LINE('Ey1tIBlDGrE5m0Zb81F2.hhOGzmcEzr4EJ0H64WNlSG.JTpJUIyH6KcoS0NebJYBsCRccg3nTXpos95g7Ss1b3Q=')
dna3.log("Auth Token : " + str(dna3.authToken))
channelToken = dna3.getChannelResult()
dna3.log("Channel Token : " + str(channelToken))

dna4 = LINE('EyiCnXv6MNIUjiAFISG4.ec3LnAd8A4+jYJygjMEaPa.dyj+E2eaUq2YPTG9cKqthIl5u9byrEB7BBfLb+Akoks=')
dna4.log("Auth Token : " + str(dna4.authToken))
channelToken = dna4.getChannelResult()
dna4.log("Channel Token : " + str(channelToken))

dna5 = LINE('EyziQeFz9bXjo7imq4Sa.PXn43fTAMoUbWnlGjk2R6G.QKvcV+7Fa/1dYzttglzFm9Fe++fzpW6FJqnX1/S+4lY=')
dna5.log("Auth Token : " + str(dna5.authToken))
channelToken = dna4.getChannelResult()
dna5.log("Channel Token : " + str(channelToken))

dna6 = LINE('EyMbGBicmGC1aT0ZPcmd.rjcuqNHrouh3tSfGR1PmJq.3X4A7pHZuzpzZQzuGiKw2oWPF6I5BcYQaHRsRMGdZb8=')#kicker 
dna6.log("Auth Token : " + str(dna6.authToken))
channelToken = dna3.getChannelResult()
dna6.log("Channel Token : " + str(channelToken))

dna7 = LINE('EyeIqAT4qy4Kms0KkRl9.fNVeUXlOXvHo2KtozbJkwq.m6YOq4RqlJgho8IxcR9XyQcmWyip/8iPPC8aEVLLXAU=')#kicker
dna7.log("Auth Token : " + str(dna7.authToken))
channelToken = dna4.getChannelResult()
dna7.log("Channel Token : " + str(channelToken))

dna8 = LINE('ExVP5aYHfm0AwUIIYMcb.HBtw/xWM5kMjqcgpb+NoYW.zpaqP6dFxGlsqgdCQzILZr4y1eIQPdf1BzdqWbK1LLA=')#kicker
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u43e02f888bfa5dad92a07b94a454b76f","u2eee52d1c65aa29c09a05e1328183f60","ue88d5265192c3888bdc1750c9d27b58c","u82ee17d87c6a298ab57be939847fc2ef","u7a6d2813820c7c62b1216afb633d7368"]
admin=["u03858028f62170f7c412f503c35f18c1","u43e02f888bfa5dad92a07b94a454b76f","u2eee52d1c65aa29c09a05e1328183f60","ue88d5265192c3888bdc1750c9d27b58c","u82ee17d87c6a298ab57be939847fc2ef","u7a6d2813820c7c62b1216afb633d7368"]

Owner=["u03858028f62170f7c412f503c35f18c1","u43e02f888bfa5dad92a07b94a454b76f","u2eee52d1c65aa29c09a05e1328183f60","ue88d5265192c3888bdc1750c9d27b58c","u82ee17d87c6a298ab57be939847fc2ef","u7a6d2813820c7c62b1216afb633d7368"]
creator=["u43e02f888bfa5dad92a07b94a454b76f"]
wait = {
    'contact':False,
    'joingc':"😂",
    'leftgc':" 😂😂😂",
